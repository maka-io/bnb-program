...
public partial class GuestForm : Form
{
    ...
    private void SetupDataBindings()
    {
        ...
        txtConfirmationNumber.DataBindings.Add("Text", _bindingSource, nameof(Guest.ConfirmationNumber), true);
    ...
    private void btnInsert_Click(object sender, EventArgs e)
    {
        ...
        // Create new guest with next confirmation number
        var maxConf = _dbContext.Guests.Any()
            ? _dbContext.Guests.Max(g => g.ConfirmationNumber)
            : 0;

        _currentGuest = new Guest
        {
            ConfirmationNumber = maxConf + 1,
            FirstName = "",
            LastName = "",
    ...
    private void btnDelete_Click(object sender, EventArgs e)
    {
        if (_bindingSource.Current is Guest guest)
        {
            ...
            var result = MessageBox.Show(
                $"Are you sure you want to delete guest '{guest.FirstName} {guest.LastName}' (Conf# {guest.ConfirmationNumber})?",
                "Confirm Delete",
    ...
    private void btnFind_Click(object sender, EventArgs e)
    {
        ...
        if (searchForm.ShowDialog(this) == DialogResult.OK && searchForm.SearchCriteria != null)
        {
            ...
            var results = query.OrderByDescending(g => g.ConfirmationNumber).ToList();
