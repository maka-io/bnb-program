...
partial class TravelAgencyForm
{
    ...
    private void InitializeComponent()
    {
        ...
        this.splitContainer.Size = new Size(700, 600);
        ...
        // Account Number
        AddLabelAndField(panelForm, lblAccountNumber, "Account #:", txtAccountNumber, labelX, y, fieldX, 100);
        ...
        this.Text = "Travel Agency Accounts";
        this.Load += TravelAgencyForm_Load;
        this.FormClosing += TravelAgencyForm_FormClosing;
