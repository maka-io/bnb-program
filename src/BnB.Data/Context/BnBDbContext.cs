...
public class BnBDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Property>(entity =>
        {
            ...
            entity.Property(e => e.PropertyState).HasMaxLength(20);
            entity.Property(e => e.PropertyZipCode).HasMaxLength(20);
            entity.Property(e => e.PropertyPhone).HasMaxLength(30);
            entity.Property(e => e.PropertyFax).HasMaxLength(30);
            ...
            entity.Property(e => e.MailingPhone1).HasMaxLength(30);
            entity.Property(e => e.MailingPhone2).HasMaxLength(30);
            entity.Property(e => e.MailingFax).HasMaxLength(30);
            entity.Property(e => e.Email).HasMaxLength(100);
