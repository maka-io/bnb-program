        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyGrossRate = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    DailyNetRate = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    TotalGrossWithTax = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    TotalNetWithTax = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    TotalTax = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    Tax1 = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    Tax2 = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    Tax3 = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    ServiceFee = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
