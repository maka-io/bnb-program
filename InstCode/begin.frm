...
Private Sub cmdInstall_Click()
    ...
    'Don't write over existing BNB1.MDB file
    If Not IsWorkstation Then
       If FileExists(gstrDestDir & "BNB1.MDB") Then
          MsgBox "Database file (BNB1.MDB) already exists in selected " & _
                 "setup directory. Setup will not overwrite this file. " & _
                 "It must be manually removed or renamed before continuing.", _
                 MB_ICONSTOP, Me.Caption
          Exit Sub
       End If
    End If
...
Private Sub Form_Load()
    ...
    cmdInstall.Default = True 'paultest
